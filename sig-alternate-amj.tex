...
%amj: explicar claramente o que é diversificado (p.e. certificados? é certificados e chaves?)
...
%amj: currently doing this:
% --- [DONE] Hash functions(Mac) & PK(Kx and Au) -- utilizei as mesmas métricas (talvez seja possivel adicionar alguma metrica)
% --- [DONE] Symmetric Key (Enc) -- utilizei as minhas métricas
